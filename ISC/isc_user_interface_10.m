...
% ISC function with parameters used for first speech part. For explanations, refer to isc_user_interface.m
...
parameters.order=3;
parameters.window=286;
parameters.thresholding=0;
parameters.thresholdlevel=0.05/2;
parameters.inv_op='inv.mat';
parameters.pattern = {'a';'b';'c';'d';'e';'f';'g';'h';'l';'speech*_ssp.fif'};
parameters.invname = {'a';'b';'c';'d';'e';'f';'g';'h';'l';'speech'};
parameters.fileids=10;
frequencies=[0.5 4; 4 8; 8 12; 12 25; 25 45; 55 90];
possible_styles={'beginning_time', 'start_time', 'start_end', 'define_start'};
choice_of_style='start_end';
start_time=zeros(1,length(parameters.subjects));
parameters.stimulus_time=[0,0,0,0,0,0,0,0,0,285];
...
parameters.should_the_inverse_operators_be_updated=1;
...
parameters.envelopes_only=1;
parameters.correlations_only=0;
parameters.averages_only=0;
