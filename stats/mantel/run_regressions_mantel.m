% Perform Mantel test. Compute surrogate models to estimate the null
% distribution.
...
regress_IQ_out = 0; % 0 = no, 1 = yes; regresses IQ out from brain data
if regress_IQ_out==1
    results_path = '/media/cbru/SMEDY/DATA/correlations_mantel/2019_03_IQ_regressed_out/';
else
    results_path = '/media/cbru/SMEDY/DATA/correlations_mantel/2019_05_simple_model/';
end
